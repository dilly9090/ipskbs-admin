...
use Auth;
use PDF;
class InstrumenLaporangKejadianController extends Controller
{
    public function index()
    {
        $data=InstrumenLaporanKejadian::with('user')->get();
        $provinsi=Provinsi::all();
        return view('pages.instrumen.laporan.index')->with('data',$data)->with('provinsi',$provinsi);
    }
    ...
    {
        $det=InstrumenLaporanKejadian::find($id);
        ...
        $pdf = PDF::loadView('pages.instrumen.laporan.cetak',$data); //load view page
