...
class InstrumenAssesmentPemulianController extends Controller
{
    ...
    {
        $data=InstrumenAssesmentPemulian::find($id);
        $provinsi=Provinsi::all();
        return view('pages.instrumen.assesment-pemulihan.detail')->with('data',$data)->with('provinsi',$provinsi);
    }
    ...
    public function data_laporan_verifikasi(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-bahan-bangunan/'.$id)->with('pesan','Data Laporan berhasil Di Verifikasi');
    }
    ...
    public function data_laporan_upload_nodin(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-bahan-bangunan/'.$id)->with('pesan','Nota Dinas Kasubdit Berhasil Di Unggah');
    }
    public function data_laporan_upload_sk(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-bahan-bangunan/'.$id)->with('pesan','SK Direktur Berhasil Di Unggah');
    }
    public function data_laporan_disposisi(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-bahan-bangunan/'.$id)->with('pesan','Disposisi Direktur Berhasil Di Tambahkan');
    }
    public function cetak_laporan($id)
    {
        $det=InstrumenAssesmentPemulian::find($id);
        ...
        $pdf = PDF::loadView('pages.instrumen.assesment-pemulihan.cetak',$data); //load view page
