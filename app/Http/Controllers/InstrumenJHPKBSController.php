...
class InstrumenJHPKBSController extends Controller
{
    ...
    {
        $data=InstrumenJHPKBS::find($id);
        $provinsi=Provinsi::all();
        return view('pages.instrumen.kejadian.detail')->with('data',$data)->with('provinsi',$provinsi);
    }
    ...
    public function data_laporan_verifikasi(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-jaminan/'.$id)->with('pesan','Data Laporan berhasil Di Verifikasi');
    }
    ...
    public function data_laporan_upload_nodin(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-jaminan/'.$id)->with('pesan','Nota Dinas Kasubdit Berhasil Di Unggah');
    }
    public function data_laporan_upload_sk(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-jaminan/'.$id)->with('pesan','SK Direktur Berhasil Di Unggah');
    }
    public function data_laporan_disposisi(Request $request, $id)
    {
        ...
        return redirect('data-bantuan-jaminan/'.$id)->with('pesan','Disposisi Direktur Berhasil Di Tambahkan');
    }
    public function cetak_laporan($id)
    {
        $det=InstrumenJHPKBS::find($id);
        ...
        $pdf = PDF::loadView('pages.instrumen.kejadian.cetak',$data); //load view page
