...
@section('konten')
                    ...
                    <div class="row">
                        ...
                        <a href="{{url('master-jenis')}}">
                            <div class="col-lg-3 text-center">
                                <!-- Traffic sources -->
                                <div class="panel panel-flat" style="padding:0 20px 20px 20px;">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">Jenis Bencana</h5>	
                                    </div>
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="btn bg-indigo-400 btn-float btn-float-lg legitRipple"><i class="icon-file-text"></i> <span></span></button>
                                            </div>
                                        </div>
                        ...
                        <a href="{{url('master-kebutuhan')}}">
                            <div class="col-lg-3 text-center">
                                <!-- Traffic sources -->
                                <div class="panel panel-flat" style="padding:0 20px 20px 20px;">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">Jenis Kebutuhan</h5>	
                                    </div>
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" class="btn bg-indigo-800 btn-float btn-float-lg legitRipple"><i class="icon-file-text"></i> <span></span></button>
                                            </div>
                                        </div>
