...
@section('breadcumb')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Jenis Kebutuhan</li>
        </ul>
                ...
                <tbody>
                    ...
                    @foreach ($jenis as $im)
                        ...
                        <tr>
                                ...
                                <td class="">{{$im->jenis}}</td>
                                <td class="text-left">{{$im->keterangan}}</td>
                                <td>
                                    @if ($im->flag==1)
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Tambah Data Jenis Kebutuhan</h4>
				</div>
				<div class="modal-body">
					<form action="{{ route('master-kebutuhan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">	
                                    <label>Status</label>
                                    <select name="flag"  palceholder="Status" class="selectbox" style="">
                                        <option>- Pilih -</option>
	...
	<div class="modal fade" id="modalhapus" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">Konfirmasi Hapus Data Jenis</h4>
				</div>
				<div class="modal-body">
...
@section('footscript')
    ...
    $(document).ready(function(){
        ...
        $('#table').on('click', '.btn-edit', function(){
            ...
            $.ajax({
                url: "{{ url('master-kebutuhan') }}/"+id+"/edit",
                success: function(res) {
					$('#form-update').attr('action', "{{ url('master-kebutuhan') }}/"+id)
					$('#jenis').val(res.jenis);
        ...
        $('#table').on('click', '.btn-delete', function(){
            var id = $(this).data('value')
			$('#form-delete').attr('action', "{{ url('master-kebutuhan') }}/"+id)			
        })
