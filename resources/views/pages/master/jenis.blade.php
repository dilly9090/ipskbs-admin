...
@section('title')
    <title>Data Jenis Bencana - SIMANDAT</title>
@endsection
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Tambah Data Jenis Bencana</h4>
				</div>
				<div class="modal-body">
					<form action="{{ route('master-jenis.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
...
@section('footscript')
    ...
    $(document).ready(function(){
        ...
        $('#table').on('click', '.btn-edit', function(){
            ...
            $.ajax({
                url: "{{ url('master-jenis') }}/"+id+"/edit",
                success: function(res) {
					$('#form-update').attr('action', "{{ url('master-jenis') }}/"+id)
					$('#jenis').val(res.jenis);
        ...
        $('#table').on('click', '.btn-delete', function(){
            var id = $(this).data('value')
			$('#form-delete').attr('action', "{{ url('master-jenis') }}/"+id)			
        })
