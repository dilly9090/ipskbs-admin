...
@section('title')
    <title>Instrumen Bantuan Jaminan Hidup - SIMANDAT</title>
@endsection
                ...
                <table class="table table-basic table-striped" id="table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Waktu Assesment</th>
                ...
                <tbody>
                    @foreach ($data as $im)
                        ...
                        <tr>
                                ...
                                <td class="text-left">{{date('d-m-Y',strtotime($im->waktu_assement))}}</td>
                                <td>
                                    @if ($im->status==0)
                                ...
                                <td>
                                    <div style="width:100px">
                                        <a class="btn btn-xs btn-success" href="{{url('data-bantuan-santuan/'.$im->id)}}" style="padding:4px 5px !important" title="Detail Laporan">
                                                    <i class="icon-eye"></i>
                                                </a>
