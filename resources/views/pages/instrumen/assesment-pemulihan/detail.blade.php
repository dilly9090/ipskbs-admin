...
@section('breadcumb')
    <div class="breadcrumb-line">
        ...
        <ul class="breadcrumb-elements">
            <li class="">
                <a href="{{url('data-bantuan-bahan-bangunan')}}" class=""><span class="label label-info"><< Kembali</span></a>
            </li>
        </ul>
    </div>
@endsection
                ...
                <div class="row" style="padding:10px;">
                    <div class="col-md-7">
                       ...
                       <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                        ...
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            <div class="col-md-4">Dasar Penugasan</div>
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7">
                                <b>Nomor : {{isset($data->nomor_penugasan)}}</b><br>
                                <b>Perihal : {{isset($data->perihal_penugasan)}}</b>
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                        ...
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            ...
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{date('d/m/Y',strtotime($data->tanggal_kejadian))}}</b></div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            ...
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{$data->penyebab}}</b></div>
                        </div>
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            <div class="col-md-4">Jumlah Korban Meninggal</div>
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{$data->jlh_meninggal}} Orang</b></div>
                        </div>
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            <div class="col-md-4">Jumlah Korban Luka</div>
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{$data->jlh_luka}} Orang</b></div>
                        </div>
                       
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            <div class="col-md-4">Jumlah Rusak Berat</div>
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{$data->jlh_rusak_berat}} Unit</b></div>
                        </div>
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            <div class="col-md-4">Jumlah Rusak Sedang</div>
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{$data->jlh_rusak_sedang}} Unit</b></div>
                        </div>
                        <div class="row" style="margin-bottom:10px;border-bottom:1px solid #eee;">
                            <div class="col-md-4">Jumlah Rusak Ringan</div>
                            <div class="col-md-1 text-right">:</div>
                            <div class="col-md-7"><b>{{$data->jlh_rusak_ringan}} Unit</b></div>
                        </div>
                        ...
                        <div class="row" style="width:95%">
                            ...
                            @elseif($data->status=='1')
                                ...
                                <div class="col-md-9" style="">
                                    <a href="{{url('cetak-laporan-bb/'.$data->id)}}" class="btn bg-blue-700 btn-float btn-float-lg legitRipple" style="font-size:30px;width:100%;height:40px;padding-top:5px;" data-popup="tooltip" title="" data-original-title="Cetak Berkas">
...
<script>
    ...
    {
        $('#form-verifikasi').attr('action', "{{ url('data-bantuan-bahan-bangunan-verifikasi') }}/"+id)	
        $('#modalverifikasi').modal('show');
    }
    function tidaklengkap(id)
    {
        $('#form-verifikasi').attr('action', "{{ url('data-bantuan-bahan-bangunan-tidak-lengkap') }}/"+id)	
        $('#modalverifikasi').modal('show');
    }
    function uploadnodin(id)
    {
        $('#form-upload').attr('action', "{{ url('data-bantuan-bahan-bangunan-upload-nodin') }}/"+id)	
        $('#modaluploadnodin').modal('show');
    }
    function uploadsk(id)
    {
        $('#form-upload-sk').attr('action', "{{ url('data-bantuan-bahan-bangunan-upload-sk') }}/"+id)	
        $('#modaluploadsk').modal('show');
    }
    function disposisidir(id)
    {
        $('#form-disposisi').attr('action', "{{ url('data-bantuan-bahan-bangunan-disposisi') }}/"+id)	
