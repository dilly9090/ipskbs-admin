                ...
                <tbody>
                    @foreach ($data as $im)
                        ...
                        <tr>
                                ...
                                <td class="text-left">{{date('d-m-Y',strtotime($im->tanggal_kejadian))}}</td>
                                <td>
                                    @if ($im->status==0)
                                ...
                                <td>
                                    <div style="width:100px">
                                        <a class="btn btn-xs btn-success" href="{{url('data-bantuan-bahan-bangunan/'.$im->id)}}" style="padding:4px 5px !important" title="Detail Laporan">
                                                    <i class="icon-eye"></i>
                                                </a>
