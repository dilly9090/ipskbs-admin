...
<head>
	...
	<title>Login Form : iPSKBS-PSKBS</title>
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="row" style="margin-top:-20px;">
                        <div style="text-align:center;width:100%;margin-top:-20px;">
                            <div style="" class="div-logo-kemensos">
                                ...
                                <div style="">
                                    <div>
                                        <span style="" class="text-simandat">i</span> <span style="" class="text-pskbs">PSKBS</span>
                                    </div>
                    ...
                    <form action="{{route('login')}}" style="margin-top:0px;" method="POST">
                        @csrf
						<div class="panel panel-body login-form" style="background:#fff !important;">
...
#radial-center {
  ...
  background: -webkit-gradient(radial, center center, 0, center center, 460, from(#ffffff), to(#00eef1));

  /* Safari 5.1+, Chrome 10+ */
  background: -webkit-radial-gradient(circle, #ffffff, #00eef1);

  /* Firefox 3.6+ */
  background: -moz-radial-gradient(circle, #ffffff, #00eef1);

  /* IE 10 */
  background: -ms-radial-gradient(circle, #ffffff, #00eef1);
